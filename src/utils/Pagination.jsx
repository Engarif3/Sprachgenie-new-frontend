// when i press  quickly next button two timess and then press prev button two times. the page keeps going nrxt and previous. stop this abnormal behaviour:
...
//         <button
//           onClick={toggleView}
//           className="btn btn-sm btn-outline btn-info mt-6"
//         >
//           Show All Words
//         </button>
//       )}
...
//         <button
//           onClick={toggleView}
//           className="btn btn-sm btn-warning fixed bottom-16 left-1/2"
//         >
//           Show Paginated View
//         </button>
//       )}
...
//             <button
//               onClick={() => {
//                 if (debounceTimeout) clearTimeout(debounceTimeout); // Clear the previous timeout if any
//                 setDebounceTimeout(
//                   setTimeout(() => {
//                     setCurrentPage((prevPage) => Math.max(prevPage - 1, 1));
//                   }, 300)
//                 ); // Adding debounce delay of 300ms
//               }}
