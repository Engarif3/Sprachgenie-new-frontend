...
const IpRateLimits = () => {
  ...
  return (
    <div className="max-w-lg mx-auto bg-white shadow p-6 rounded-lg mt-6">
      <h2 className="text-xl font-semibold mb-1">IP Rate Limits</h2>
      <p className="text-sm text-gray-500 mb-4">
        Shared cap applied per client IP address across all AI generation
        (paragraphs and conjugations), regardless of which user account is
        signed in.
      </p>
      <form onSubmit={handleSubmit} className="space-y-4">
        <label htmlFor="ip-burst-limit" className="block text-sm font-medium">
        ...
        />
        <label htmlFor="ip-daily-limit" className="block text-sm font-medium">
