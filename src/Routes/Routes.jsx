...
const IpUsage = lazy(() => import("../AI/IpUsage"));
      ...
      children: [
...

        {
          ...
          children: [
            ...
            {
              path: "notifications",
              element: protectRoute(<NotificationsPageWithSuspense />),
            },
            {
              path: "create-conversation",
              element: protectRoute(
            ...
            {
              path: "ip-usage",
              element: protectRoute(<IpUsageWithSuspense />, ADMIN_ROLES),
            },
            {
