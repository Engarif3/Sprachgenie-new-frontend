...
//           <span className=" text-lg border rounded-md bg-cyan-700 p-2 text-white font-bold">
...
//                           {item.Verb}
//                         </span>{" "}
//                         - <span className="">({item.Meaning})</span>
//                       </span>
//                     </span>
//                   </div>
//                 )}
    ...
    <Container>
      <div className=" mx-auto mt-16 mb-24 p-1">
        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-between items-center ">
          ...
          <div className="text-center mb-2 md:mb-0 lg:mb-0 w-full md:w-4/12 lg:w-4/12 border  hidden md:block lg.block">
