...
//       {/* Static center text */}
//       {centerText && (
//         <div className="absolute inset-0 flex justify-center items-center text-white text-lg font-bold pointer-events-none">
//           {centerText}
//         </div>
//       )}
//     </motion.div>
  ...
  return (
    ...
    >
      ...
      {(centerText1 || centerText2) && (
        <div className="absolute inset-0 flex justify-center items-center text-red-600 text-lg font-bold pointer-events-none">
          <span>{centerText1}</span>
          <span className="text-white">{centerText2}</span>
        </div>
      )}
    </div>
  );
