...
const PrefixTypeList = () => {
  ...
  return (
    <Container>
      <div className="max-w-7xl mx-auto px-4 pt-1 pb-4 mb-4 min-h-screen">
        {/* Header Section */}
        <div className="text-center mb-3 mt-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500 pb-2">
            Prefix Types
          </h2>
