...
// Shared floating-panel dropdown — same trigger/panel visual language as the
// "All Types" part-of-speech filter on the word list (dark themed panel,
// cyan-by-default accent, rounded-xl trigger). Used in place of native
// <select> elements, which fall back to the browser's own unstyled dropdown
// list when opened.
  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        className={`border border-gray-600 dark:bg-gray-800 backdrop-blur-sm rounded-xl px-4 py-3 w-full dark:text-white ${focusBorderClass} focus:ring-2 ${focusRingClass} transition-all text-left flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed ${triggerClassName}`}
